# Algoritmo recursivo para calcular el n-enesimo número de Fibonacci e imprimirlo
.data
...
main:
    ...
    jal fibo             # Saltar a fibo para imprimir en número. 
    ...
    syscall
# Función recursiva para calcular en termino 
fibo:
